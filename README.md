...
**한 길 물낯**은 로컬 인물 이미지 perturbation 실험과 방어 평가를 위한 Android 앱입니다. 선택한 이미지에 보호용 변형을 적용하고, 복원 시도 이후에도 얼굴 감지 방해 효과가 유지되는지 기기 안에서 점검합니다.
...
- Android 갤러리 또는 공유 시트에서 인물 이미지를 불러옵니다.
